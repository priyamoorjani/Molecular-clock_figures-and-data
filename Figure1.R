...
plot(tree, edge.color = vec.color, tip.color=c("blueviolet","blueviolet","blueviolet","lightseagreen","lightseagreen","lightseagreen","lightseagreen","coral2","coral2","chocolate4","black"), use.edge.length=TRUE,label.offset=0.002)
legend("bottomleft",col=c("blueviolet","lightseagreen","coral2","chocolate4","black"),lty=1,legend=c("Hominoids","Old World Monkeys","New World Monkeys","Prosimians","Outgroup"),cex=1, lwd = 1.5)
